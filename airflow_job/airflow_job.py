...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projects-gds-1")
    bq_project = Variable.get("bq_project", default_var="crucial-nuance-442516-q2")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "463083603815-compute@developer.gserviceaccount.com",
                "network_uri": "projects/crucial-nuance-442516-q2/global/networks/default",
                "subnetwork_uri": "projects/crucial-nuance-442516-q2/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="crucial-nuance-442516-q2",
        region="us-central1",
